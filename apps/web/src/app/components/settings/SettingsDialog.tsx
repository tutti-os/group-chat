...
export function SettingsDialog(props: {
  ...
  return (
    <section className={"[position:fixed] [inset:0] [z-index:55] [display:grid] [place-items:center] [background:rgb(0_0_0_/_46%)]"} aria-label={t("settings.title")}>
            ...
            <section className={"[min-height:430px]"}>
              <div className={"[display:flex] [align-items:flex-start] [justify-content:space-between] [gap:24px] [padding-right:34px]"}>
                <div className={"[display:grid] [gap:6px]"}>
                  ...
                  <p className={"[margin:0] [color:var(--muted)] [font-size:13px] [line-height:1.5]"}>{t("settings.account.desc")}</p>
                </div>
              ...
              <div className={"[margin-top:28px] [display:grid] [gap:22px]"}>
                <section className={"[display:grid] [grid-template-columns:128px_minmax(0,_1fr)] [gap:18px_28px] [align-items:start] [border-top:1px_solid_var(--border)] [padding-top:22px] max-[760px]:[grid-template-columns:1fr]"}>
                  <div>
                    <h4 className={"[margin:0_0_6px] [color:var(--text)] [font-size:14px] [font-weight:720]"}>{t("settings.account.basicInfo")}</h4>
                    <p className={"[margin:0] [color:var(--muted)] [font-size:12px] [line-height:1.45]"}>{t("settings.account.basicDesc")}</p>
                  </div>
                ...
                <section className={"[display:grid] [grid-template-columns:128px_minmax(0,_1fr)] [gap:18px_28px] [align-items:start] [border-top:1px_solid_var(--border)] [padding-top:22px] max-[760px]:[grid-template-columns:1fr]"}>
                  <div>
                    <h4 className={"[margin:0_0_6px] [color:var(--text)] [font-size:14px] [font-weight:720]"}>{t("settings.account.avatar")}</h4>
                    <p className={"[margin:0] [color:var(--muted)] [font-size:12px] [line-height:1.45]"}>{t("settings.account.avatarDesc")}</p>
                  </div>
                  <AvatarPicker
